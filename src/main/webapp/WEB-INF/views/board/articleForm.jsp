...
<body>
	...
	<form name="articleForm" action="${contextPath}/board/addNewArticle.do"
		method="post" enctype="multipart/form-data">
		<table border="0" align="center">
			<tr>
				<td align="right">작성자</td>
				<td colspan="2" align="left"><input type="text"
					value="${member.name}" size="20" maxlength="100" readOnly /></td>
			</tr>

			<tr>
				<td align="right">글제목</td>
				<td colspan="2"><input type="text" name="title" size="67"
					maxlength="500" /></td>
			</tr>
